...
router.get("/", (0, checkAuth_1.checkAuth)(user_interface_1.UserRole.ADMIN), booking_controller_1.BookingController.getAllBookings);
// Member endpoints
...
// Admin update status
router.patch("/status/:id/", (0, checkAuth_1.checkAuth)(user_interface_1.UserRole.ADMIN), (0, validateRequest_1.validateRequest)(booking_validation_1.updateBookingStatusZodSchema), booking_controller_1.BookingController.updateBookingStatus);
